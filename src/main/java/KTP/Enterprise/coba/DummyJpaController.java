 ...
 */
package KTP.Enterprise.coba;

import KTP.Enterprise.coba.exceptions.NonexistentEntityException;
import KTP.Enterprise.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("KTP_Enterprise_jar_0.0.1-SNAPSHOTPU");
